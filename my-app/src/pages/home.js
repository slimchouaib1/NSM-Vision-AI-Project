...
useEffect(() => {
  ...
  AOS.refresh(); // Rafraîchit AOS après que le contenu soit chargé
...
<div className="d-flex align-items-center gap-3">
          ...
          <Link to="/credit" className="cta-btn">Apply for Credit</Link>
      ...
      <div className="container d-flex flex-column align-items-center">
        ...
        <div className="d-flex mt-4" data-aos="fade-up" data-aos-delay="300">
          ...
          <button onClick={() => navigate("/credit")} className="btn-get-started">
            Apply for Credit
          </button>
